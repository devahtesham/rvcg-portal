...
import { DeletePropertyFeature, DeletePropertyStatus, DeletePropertyTypes, GetPropertyFeatures, GetPropertyStatuses, GetPropertyTypes } from '../../../store/slices/propertyManagementSlice/propertyManagementSlice';
...
const PropertyStatus = () => {
  ...
  const { isLoading, propertyStatuses } = useSelector((state) => state.PropertyMangementReducer)
  ...
  const deleteHandler = (value) => {
    dispatch(DeletePropertyStatus(value.id))
      .then((response) => {
  ...
  return (
    <>
            ...
            <div className="property-listing-grid mt-5">
              <Row className='justify-content-center'>
                <Col lg={11}>
                  ...
                  <DataGridGlobal
                    data={propertyStatuses.length ? propertyStatuses : []}
                    columns={columns}
                    options={options}
                  />
                </Col>
      ...
      <ModalGlobal>
        <AddPropertyStatus isEdit={isEdit} data={document} />
      </ModalGlobal>
