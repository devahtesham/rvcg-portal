...
import { DeleteLeadSource, DeleteLeadType, DeletePackage, DeletePropertyTypes, GetLeadSources, GetLeadType, GetPackages, GetPropertyTypes } from '../../../store/slices/propertyManagementSlice/propertyManagementSlice';
...
const Packages = () => {
    ...
    const { isLoading, packages } = useSelector((state) => state.PropertyMangementReducer)
    useEffect(() => {
    ...
    const deleteHandler = (value) => {
        ...
        dispatch(DeletePackage(value.id))
            .then((response) => {
    ...
    return (
        <>
            ...
            <ModalGlobal>
                <AddPackageForm isEdit={isEdit} data={document} />
            </ModalGlobal>
