...
import { DeleteLeadSource, DeleteLeadType, DeletePackageItems, DeletePropertyTypes, GetLeadSources, GetLeadType, GetPackagItems, GetPropertyTypes } from '../../../store/slices/propertyManagementSlice/propertyManagementSlice';
...
const PackageItems = () => {
    ...
    const { isLoading, packageItems } = useSelector((state) => state.PropertyMangementReducer)
    useEffect(() => {
    ...
    const deleteHandler = (value) => {
        ...
        dispatch(DeletePackageItems(value.id))
            .then((response) => {
    ...
    return (
        <>
                        ...
                        <div className="property-listing-grid mt-5">
                            <Row className='justify-content-center'>
                                <Col lg={11}>
                                    ...
                                    <DataGridGlobal
                                        data={packageItems?.length ? packageItems : []}
                                        columns={columns}
                                        options={options}
                                    />
                                </Col>
            ...
            <ModalGlobal>
                <AddPackageItemForm isEdit={isEdit} data={document} />
            </ModalGlobal>
